...
subtitle:   讲述Spring一大重要特性AOP和如何理解它
date:       2018-05-04             
author:     jessehzx                
...
Spring的面向切面编程可以完美解决。面向切面编程指的是在原来代码的基础上，加上增强的部分，生成一个代理的对象，也就是说，程序员可以在不修改源代码的情况下，实现对目标类的增强，其原理就是将一个被AOP(Aspect Oriented Programming)动态增强的类，通过Java动态代理模式生成一个代理类。
